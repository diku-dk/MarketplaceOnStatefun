...
public class OrderTest {
    ...
    @Test
    public void testReceiveAttemptReservationResponse() throws Throwable {
        ...
        AttemptReservationResponse reservationResponse = new AttemptReservationResponse(1,item.getSellerId(), item.getProductId(), Enums.ItemStatus.IN_STOCK);
